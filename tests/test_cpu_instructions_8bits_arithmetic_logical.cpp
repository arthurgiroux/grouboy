...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, DAAWithMsbHigherThan9AndLsbLowerThan9AndWithoutFlagsShouldIncreaseValueBy60AndSetCarry) {
    cpu.setHalfCarryFlag(false);
    cpu.setCarryFlag(false);
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, DAAWithMaxMsbAndLsbLowerThan9AndWithoutFlagsShouldIncreaseValueBy60AndSetCarry) {
    cpu.setHalfCarryFlag(false);
    cpu.setCarryFlag(false);
