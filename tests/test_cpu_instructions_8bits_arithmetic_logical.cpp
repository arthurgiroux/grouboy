...
{
  protected:
	void assertIncrementRegisterWasPerformed(byte instruction, byte expectedValue)
	{
		mmu.write(cpu.getProgramCounter(), instruction);
		int ticks = cpu.fetchDecodeAndExecute();
		ASSERT_EQ(ticks, 1);
		ASSERT_FALSE(cpu.isFlagSet(CPU::CpuFlags::SUBSTRACTION));
		ASSERT_EQ(cpu.isFlagSet(CPU::CpuFlags::HALF_CARRY), expectedValue == 0x10);
	...
	void assertDecrementRegisterWasPerformed(byte instruction, byte expectedValue)
	{
		mmu.write(cpu.getProgramCounter(), instruction);
		int ticks = cpu.fetchDecodeAndExecute();
		ASSERT_EQ(ticks, 1);
		ASSERT_TRUE(cpu.isFlagSet(CPU::CpuFlags::SUBSTRACTION));
		ASSERT_EQ(cpu.isFlagSet(CPU::CpuFlags::HALF_CARRY), expectedValue == 0x0F);
		ASSERT_EQ(cpu.isFlagSet(CPU::CpuFlags::ZERO), expectedValue == 0);
		ASSERT_FALSE(cpu.isFlagSet(CPU::CpuFlags::CARRY));
		ASSERT_EQ(cpu.getProgramCounter(), 1);
	}
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterAForZeroShouldDoNothing)
{
	cpu.setRegisterA(0x00);
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterAShouldShiftByOne)
{
	cpu.setRegisterA(0x01);
	assertShiftLeftArithmeticRegisterWasPerformed(extendedInstructions::SLA_A);
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterAShouldCarryLastBit)
{
	cpu.setRegisterA(0xFF);
	assertShiftLeftArithmeticRegisterWasPerformed(extendedInstructions::SLA_A);
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterBForZeroShouldDoNothing)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterBShouldShiftByOne)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterBShouldCarryLastBit)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterCForZeroShouldDoNothing)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterCShouldShiftByOne)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterCShouldCarryLastBit)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterDForZeroShouldDoNothing)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterDShouldShiftByOne)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterDShouldCarryLastBit)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterEForZeroShouldDoNothing)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterEShouldShiftByOne)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterEShouldCarryLastBit)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterHForZeroShouldDoNothing)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterHShouldShiftByOne)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterHShouldCarryLastBit)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterLForZeroShouldDoNothing)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterLShouldShiftByOne)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticRegisterLShouldCarryLastBit)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticMemoryHLForZeroShouldDoNothing)
{
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticMemoryHLShouldShiftByOne)
{
	uint16_t addr = 0x1234;
	cpu.setRegisterH(getMsbFromWord(addr));
	cpu.setRegisterL(getLsbFromWord(addr));
...
TEST_F(CpuInstructions8BitsArithmeticLogicalTest, ShiftLeftArithmeticMemoryHLShouldCarryLastBit)
{
	uint16_t addr = 0x1234;
	cpu.setRegisterH(getMsbFromWord(addr));
	cpu.setRegisterL(getLsbFromWord(addr));
